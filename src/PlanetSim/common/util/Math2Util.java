...
public class Math2Util
{
    ...
    static public double atan2(final double y, final double x)
    {
        // if x=y=0
        if ((y == 0.) && (x == 0.))
        {
    ...
    static public double pow(final double x, final double y)
    {
        if (x == 0.)
        {
            return 0.;
    ...
    static public double hsin(final double x)
    {
        return (exp(x) - exp(-x)) / 2.0;
    }

    static public double hcos(final double x)
    {
        return (exp(x) + exp(-x)) / 2.0;
    }

    static public double htan(final double x)
    {
        return hsin(x) / hcos(x);
    }

    static public double hasin(final double x)
    {
        return log(x + Math.sqrt((x * x) + 1));
    }

    static public double hacos(final double x)
    {
        return log(x + Math.sqrt((x * x) - 1));
    }

    static public double hatan(final double x)
    {
        return 0.5 * (log(1 + x) / log(1 - x));
    }

    static public double sign(final double x)
    {
        return x >= 0 ? 1 : -1;
    }

    static public double to360(final double angle)
    {
        return (angle % 360.0d) + (angle < 0 ? 360 : 0);
    }
}
